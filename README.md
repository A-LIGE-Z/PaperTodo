...
- **胶囊模式**（默认启用）— 把纸片折叠成置顶小胶囊并置顶显示。
- **胶囊自动贴边**（默认启用）— 折叠胶囊自动排到屏幕右上角贴边显示。
- **交互层级最优化** — 极度轻量的便捷交互
...
- **快捷参数启动**：通过启动参数即可显示、隐藏、切换和新建纸片，不需要在应用内增加复杂快捷键配置。
...
**代码启动**：顶栏 `MD` 按钮可用改为bat，html等后缀，直接运行
